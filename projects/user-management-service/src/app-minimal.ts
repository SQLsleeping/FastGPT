...
class MinimalApp {
  ...
  private initializeRoutes(): void {
    ...
    this.app.get('/api/v1/teams/:teamId', authenticateJWT, this.teamController.getTeam.bind(this.teamController));
    this.app.put('/api/v1/teams/:teamId', authenticateJWT, this.teamController.updateTeam.bind(this.teamController));
