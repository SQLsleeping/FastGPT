...
import { UserAuthProxy } from '@/service/support/user/userManagementProxy';
import { setCookie } from '@fastgpt/service/support/permission/controller';
import requestIp from 'request-ip';

/**
 * 增强版登录API，使用我们的用户管理服务
 * 同时保持与FastGPT现有系统的兼容性
 */
...
export default NextAPI(
  useIPFrequencyLimit({ id: 'login-by-password-enhanced', seconds: lockTime, limit: 10, force: true }),
  handler
);
